...
export function useAddEmailAddress() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      logger.error('Failed to add email address:', error)
    },
  })
}
...
export function useRemoveEmailAddress() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      logger.error('Failed to remove email address:', error)
    },
  })
}
...
export function useAddLabelToEmail() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      logger.error('Failed to add label to email:', error)
    },
  })
}
...
export function useRemoveLabelFromEmail() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      logger.error('Failed to remove label from email:', error)
    },
  })
}
...
export function useBulkMarkRead() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      logger.error('Failed to bulk update read status:', error)
    },
  })
}
