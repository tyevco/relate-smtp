...
namespace Relate.Smtp.Infrastructure.Migrations
{
    ...
    [Migration("20260209000000_AddOutboundEmailTables")]
    partial class AddOutboundEmailTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Relate.Smtp.Core.Entities.DeliveryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Relate.Smtp.Core.Entities.OutboundAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OutboundAttachments");
                });

            modelBuilder.Entity("Relate.Smtp.Core.Entities.OutboundEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Relate.Smtp.Core.Entities.OutboundRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Relate.Smtp.Core.Entities.SmtpApiKey", b =>
                {
                    ...
                    b.HasIndex("KeyPrefix", "RevokedAt")
            ...
            modelBuilder.Entity("Relate.Smtp.Core.Entities.DeliveryLog", b =>
                {
                    b.HasOne("Relate.Smtp.Core.Entities.OutboundEmail", "OutboundEmail")
                        .WithMany("DeliveryLogs")
                        .HasForeignKey("OutboundEmailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Relate.Smtp.Core.Entities.OutboundRecipient", "Recipient")
                        .WithMany()
